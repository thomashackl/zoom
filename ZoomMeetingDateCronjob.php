            ...
            if ($m->zoom_settings === null || $m->zoom_settings === 404) {
                ...
                if ($m->zoom_settings->start_time->getTimestamp() + ($m->zoom_settings->duration * 60) < $now) {
                    ...
                    if ($nextDate) {
                        ...
                        // Just update start_time and duration, all other settings are not relevant here.
                        ...
                        $result = ZoomAPI::updateMeeting($m->zoom_settings->host_id, $m->zoom_meeting_id,
                            $newSettings, $m->webinar);
